...
#[derive(Debug)]
pub struct ChainStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainState processing");
    
    let mut processor = ChainStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainStateProcessor::new(false);
